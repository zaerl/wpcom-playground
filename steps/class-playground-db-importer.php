 ...
 */
class Playground_DB_Importer extends Backup_Import_Action {
	/**
	 ...
	 *     @type string $charset        The charset to use for the generated SQL. Defaults to 'utf8mb4'.
	...
	public function generate_sql( string $database_file_path, $options = array() ) {
		...
		$defaults = array(
			'all_tables'     => true,
			'charset'        => SQL_Generator::DEFAULT_CHARSET,
			'collation'      => null,
